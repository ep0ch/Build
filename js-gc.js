...
function initMotio() {
  (function(w, undefined){
    ...
    function Motio(element, options) {
      ...
      function render() {
        ...
        jQuery(element).css('cssText', "display: block !important; background-position: " + element.style.backgroundPosition + " !important;");
  ...
  (function (jQuery) {
    ...
    // jQuery plugin
    jQuery.fn[pluginName] = function (options, callbackMap) {
      ...
      return this.each(function (i, element) {
        ...
        var plugin = jQuery.data(element, namespace);

        if (!plugin && !method) {
          // Create a new plugin object if it doesn't exist yet
          plugin = jQuery.data(element, namespace, new Motio(element, options));
          // Bind callbacks
          ...
          if (method === 'destroy') {
            jQuery.removeData(element, namespace);
          }
        }
      });
    };
...
/*
     FILE ARCHIVED ON 09:24:34 Jun 01, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:37:53 Feb 26, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 8.276
  LoadShardBlock: 395.953 (3)
  PetaboxLoader3.datanode: 663.685 (4)
  load_resource: 337.75
  PetaboxLoader3.resolve: 43.263
*/
